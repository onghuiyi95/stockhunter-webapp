...
set OUT=C:\Users\Administrator\ai-shisho\stockhunter_res
"C:\Users\Administrator\ai-shisho\_jdk21\jdk-21.0.4+7\bin\java.exe" -Xmx4g -cp "%JADX%" jadx.cli.JadxCLI -d "%OUT%" --no-src --threads-count 4 "%APK%"
echo DONE_RES
